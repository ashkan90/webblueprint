...
@mousedown="handlePinMouseDown($event, pin, true, true)"
@mouseup="handlePinMouseUp($event, pin, true, true)"
>
...
:data-pin-id="pin.id"
:data-pin-type="pin.type.id"
@mousedown="handlePinMouseDown($event, pin, true, false)"
@mouseup="handlePinMouseUp($event, pin, true, false)"
>
...
:data-pin-id="pin.id"
:data-pin-type="pin.type.id"
@mousedown="handlePinMouseDown($event, pin, false, false)"
@mouseup="handlePinMouseUp($event, pin, false, false)"
>
<div class="pin-circle" :style="{ backgroundColor: getPinColor(pin) }"></div>
    </div>
    </div>
...
:data-pin-id="pin.id"
:data-pin-type="pin.type.id"
@mousedown="handlePinMouseDown($event, pin, false, true)"
@mouseup="handlePinMouseUp($event, pin, false, true)"
>
<div class="pin-triangle"></div>
    </div>
    </div>
...
function handleMouseUp2(event: MouseEvent) {
    if (isDragging.value) {
        // Stop dragging
...
function handleKeyDown(event: KeyboardEvent) {
    // Delete node with Delete key when selected
    if (event.key === 'Delete' && props.selected) {
